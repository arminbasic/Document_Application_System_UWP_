...
namespace App4
{
    ...
    /// </summary>
    public sealed partial class AdminMode : Page
    {
        public AdminMode()
        {
        ...
        private void buttonLogin_Click(object sender, RoutedEventArgs e)
        {
           ...
           /* if (textBlockAdminUserName.Text.Equals("Armin") && textBlockAdminPassword.Text.Equals("armin"))
            {*/
                Frame.Navigate(typeof(AdminPageRequests));
          /*  }
            else textBlock1.Text = "USERNAME OR PASSWORD IS NOT CORRECT";*/
        }
    }
}
